...
namespace MyMuseo.Models
{
    public partial class ShoppingCart
    {
        ...
        public void AddToCart(Collectible collectible)
        {
            // Get the matching cart and album instances 
            var cartItem = storeDB.Carts().FirstOrDefault(
                c => c.CartId == ShoppingCartId
                && c.CollectibleId == collectible.CollectibleId);
            ...
            if (cartItem == null)
            {
                ...
                cartItem = new Cart
                {
                    ...
                    Image = collectible.NormalImage,
                    Price = collectible.Price,
                    CreatedDate = DateTime.Now
                };
                storeDB.Add(cartItem);
            }
            else
            {
